return {
	{
		...
		dependencies = {
			-- For MiniStatusline: Start
			"justinhj/battery.nvim",
			"nvim-lua/plenary.nvim",
			"nvim-tree/nvim-web-devicons",
			-- For MiniStatusline: End
		},
		...
		config = function()
			...
			battery.setup({ update_rate_seconds = 30 })
			...
			require("mini.statusline").setup({
				content = {
					...
					active = function()
						...
						local battery_status = " " .. battery.get_status_line()
						...
						return MiniStatusline.combine_groups({
							...
							{ hl = mode_hl, strings = { search, location, battery_status, time } },
						})
					end,
				},
			})
